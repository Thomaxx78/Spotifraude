<template>
    <div>
      <div class="flex items-start">
        <h3 class="font-bold text-white">Recherche :</h3>
        <input v-model="filter" type="search"
          class="ml-2 shadow border rounded py-2 px-3 text-gray-700 appearance-none leading-tight focus:outline-none focus:shadow-outline mb-5">
      </div>
